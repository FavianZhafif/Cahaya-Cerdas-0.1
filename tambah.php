        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header" style="color: #fff; background-color: #1e1e1e;">Tambah Barang</div>
                        <div class="card-body">
                            ...
                            <form method="post" action="p_tambah.php" enctype="multipart/form-data" name="form1">
                                ...
                                <div class="mb-3 mt-3 form-group">
                                    ...
                                    <input type="text" max="55" class="form-control" id="namabarang" placeholder=" masukan nama barang" name="namabarang" required>
                                </div>
