                                ...
                                <table class="table table-hover table-responsive table-bordered mt-3">
                                    <thead class="thead-dark" style="background-color: #1e1e1e;">
                                        <tr>
                                            ...
                                            <th style="font-size: 14px; text-align: center; min-width: 150px;">Nama Depan</th>
                                            <th style="font-size: 14px; text-align: center; min-width: 150px;">Nama Belakang</th>
                                            <th style="font-size: 14px; text-align: center; min-width: 200px;">Email</th>
                                            <th style="font-size: 14px; text-align: center; min-width: 161px;">Telepon</th>
                                            <th style="font-size: 14px; text-align: center; min-width: 300px;">Pesan</th>
                                        </tr>
                                    </thead>
                                    <?php
                                    if (isset($_GET['search'])) {
                                        $search = $_GET['search'];
                                        $sql = mysqli_query($koneksi, "SELECT * FROM pesan WHERE namadepan like '%" . $search . "%' OR email like '%" . $search . "%'");
                                    } else {
                                        $sql = mysqli_query($koneksi, "SELECT * FROM pesan ORDER BY id ASC");
                                    }
                                    $no = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="font-size: 14px; text-align: center;"><?= $row['namadepan']; ?></td>
                                            <td style="font-size: 14px; text-align: center;"><?= $row['namabelakang']; ?></td>
                                            <td style="font-size: 14px; text-align: center;"><?= $row['email']; ?></td>
                                            <td style="font-size: 14px; text-align: justify;"><?= $row['phone']; ?></td>
                                            <td style="font-size: 14px; text-align: justify;"><?= $row['pesan']; ?></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
